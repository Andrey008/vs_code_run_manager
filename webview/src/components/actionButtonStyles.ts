...
/* Starting: twelve orange "minute marks" arranged around the square (every
   30°, like a clock face). Each tick fades in and out on the same
   animation, but with staggered animation-delays so the bright tick
   chases its way around the ring — the classic clock-face spinner.
   12 ticks × 0.075s stagger = 0.9s full cycle. */
